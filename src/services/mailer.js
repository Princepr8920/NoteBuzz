...
const currentDate = require("../utils/timezone");
...
const sendConfirmationEmail = async (info) => {
  ...
  let body = {
    verify_Account: {
      subject: "Verify your NoteBuzz ID email address ✔",
      html: `<h1>Verify your NoteBuzz ID email address</h1>
 <h2>Hello ${username} </h2>
 <p>You have selected this email address as your NoteBuzz ID. 
 ...
 enter the code below on the email veirfication page</p>
  ...
  <strong>NoteBuzz Developer</strong>`,
    },
    reset: {
      subject: "Reset password instructions.",
      html: ` 
   <h2>Hello ${username} </h2>
   <p>You requested a link to reset your password for NoteBuzz account.
   Use the link below to login and set a new password.</p>
    <a href=${secret}>Reset my NoteBuzz account password</a>
 ...
 <h2>Hello</h2>
   <p>You recently selected ${email} as your new NoteBuzz ID. 
...
<ul>
  ...
  <p>At NoteBuzz, we take the security of your account and personal information very seriously. We have implemented various measures to protect your data and maintain a secure environment.
